           ...
           {/***product details */}
           {
            loading ? (
              <div className='grid gap-1 w-full'>
                ...
                <div className='text-pink-600 bg-slate-200 h-6 lg:h-8  animate-pulse flex items-center gap-1 w-full'>
    
                </div>

                <div className='flex items-center gap-2 text-2xl lg:text-3xl font-medium my-1 h-6 lg:h-8  animate-pulse w-full'>
                  <p className='text-pink-600 bg-slate-200 w-full'></p>
            ...
            (
              <div className='flex flex-col gap-1'>
                ...
                <div className='flex items-center gap-3 my-2'>
                  ...
                  <button className='border-2 border-red-600 rounded px-3 py-1 min-w-[120px] font-medium text-white bg-pink-600 hover:text-pink-600 hover:bg-white' onClick={(e)=>handleAddToCart(e,data?._id)}>Add To Cart</button>
                </div>
