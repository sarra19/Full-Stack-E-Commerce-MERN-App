...
const Cart = () => {
    ...
    const handlePayment = async () => {
        //alert("paiement")
        const stripePromise = await loadStripe('pk_test_51PnFuqBcKd4NYyOCZa1TRm6IBQQmPMrGDvzQkPNbyZOprV5SKTygvJuqE1iTd5EXHwgyAzmRZAzC1eFzX0Qg4IBf00eb6a2gxB')
                                    ...
                                    <div key={product?._id + "Add To Cart Loading"} className='w-full bg-white h-32 my-2 border border-slate-300  rounded grid grid-cols-[128px,1fr]'>
                                        ...
                                        <div className='px-4 py-2 relative'>
                                            ...
                                            <div className='flex items-center gap-3 mt-1'>
                                                ...
                                                <button className='border border-red-600 text-pink-600 hover:bg-pink-600 hover:text-white w-6 h-6 flex justify-center items-center rounded ' onClick={() => increaseQty(product?._id, product?.quantity)}>+</button>
                                            </div>
                                        </div>
                                    </div>
                                )
